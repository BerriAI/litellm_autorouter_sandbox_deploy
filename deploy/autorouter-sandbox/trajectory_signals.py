"""
VENDORED from BerriAI/litellm PR #39976 (branch litellm_trajectory_signals, not yet merged),
unmodified, because phase_difficulty_classifier.py needs it now and this sandbox cannot depend
on an unmerged upstream file. Delete this file and import
litellm.router_strategy.complexity_router.trajectory_signals once that PR lands.
